...
def run_flparse(data_directory):
 ...
 #         fourcc2 = cv2.cv.CV_FOURCC('M','J','P','G')
        ...
        top_contrasted = cv2.VideoWriter(data_directory + 'top_contrasted.AVI', fourcc2, 62, (1888,1888), True)
        side_contrasted = cv2.VideoWriter(data_directory + 'side_contrasted.AVI', fourcc2,62, (1888,1888), True)
